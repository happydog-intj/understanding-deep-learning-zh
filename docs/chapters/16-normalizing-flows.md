...
![图 16.1](/figures/ch16/FlowIntro.png)
...
![图 16.2](/figures/ch16/FlowIntroTransformDensity.png)
...
![图 16.3](/figures/ch16/FlowIntroInverse.png)
...
![图 16.4](/figures/ch16/FlowTransformLayers.png)
...
![图 16.5](/figures/ch16/FlowPiecewiseLinear.png)

</div>

> **图 16.5** 分段线性映射。可逆的分段线性映射 $h' = \text{f}[h, \boldsymbol{\phi}]$ 可以通过将输入域 $h \in [0, 1]$ 分成 $K$ 个等大小的区域（此处 $K = 5$）来创建。每个区域有一个斜率参数 $\phi_k$。a) 如果这些参数为正且和为一，则 b) 函数将是可逆的并映射到输出域 $h' \in [0, 1]$。
...
![图 16.6](/figures/ch16/FlowCoupling.png)
...
![图 16.7](/figures/ch16/FlowAutoregressive.png)
...
![图 16.8](/figures/ch16/FlowResidual.png)
...
![图 16.9](/figures/ch16/FlowBanach.png)
...
![图 16.10](/figures/ch16/FlowMultiscale.png)
...
![图 16.11](/figures/ch16/FlowIResNetResults.png)
...
![图 16.12](/figures/ch16/FlowGLOWSamples.png)
...
![图 16.13](/figures/ch16/FlowGLOWInterp.png)
...
![图 16.14](/figures/ch16/FlowTypeII.png)
